...
def depthFirstSearch(problem):
    ...
    fringe = util.Stack()  # fringe indicate that states to be fringe
...
def breadthFirstSearch(problem):
    ...
    fringe = util.Queue()  # fringe indicate that states to be fringe
    fringe.push(problem.getStartState())  
    currRoad = util.Queue()
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    frontier = util.PriorityQueue()
    frontier.push(problem.getStartState(), 0) # fringe indicate that states to be fringe
    currRoad = util.PriorityQueue()
    visited = []                            
    path=[]                                 # the final road to goal
